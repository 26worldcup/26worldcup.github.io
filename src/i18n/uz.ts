...
const uz: Dict = {
  ...
  exportCalendarHint: "Istalgan taqvim ilovasiga import qilishingiz mumkin bo'lgan .ics faylni yuklab oling.",
  exportScope: "Eksport qilinadigan o'yinlar",
  exportScopeFiltered: "O'yinlar sahifasidagi filtrlarga muvofiq",
  exportScopeFavorites: 'Mening jamoalarim',
  exportScopeFavoritesEmpty: 'Avval yuqoridan jamoalaringizni tanlang.',
  exportScopeAll: "Barcha o'yinlar",
  exportUpcomingOnly: "Faqat hali boshlanmagan o'yinlar",
