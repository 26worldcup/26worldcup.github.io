...
const en: Dict = {
  ...
  probDraw: 'Draw',
  probAdvance: 'To win (incl. extra time and penalties)',
  ...
  exportCalendarHint: 'Download an .ics file you can import into any calendar app.',
  exportScope: 'Matches to export',
  exportScopeFiltered: 'As filtered on the Matches page',
  exportScopeFavorites: 'My teams',
  exportScopeFavoritesEmpty: 'Pick your teams above first.',
  exportScopeAll: 'All matches',
  exportUpcomingOnly: 'Only matches that have not kicked off yet',
  ...
  aimsRealMatch: 'Real-world match',
