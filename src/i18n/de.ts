...
const de: Dict = {
  ...
  probDraw: 'Remis',
  probAdvance: 'Sieg (inkl. Verlängerung und Elfmeterschießen)',
  ...
  exportCalendarHint: 'Lade eine .ics-Datei herunter, die du in jede Kalender-App importieren kannst.',
  exportScope: 'Zu exportierende Spiele',
  exportScopeFiltered: 'Wie auf der Seite „Spiele“ gefiltert',
  exportScopeFavorites: 'Meine Teams',
  exportScopeFavoritesEmpty: 'Wähle zuerst oben deine Teams aus.',
  exportScopeAll: 'Alle Spiele',
  exportUpcomingOnly: 'Nur Spiele, die noch nicht angepfiffen sind',
