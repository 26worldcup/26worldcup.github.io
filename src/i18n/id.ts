...
const id: Dict = {
  ...
  probDraw: 'Seri',
  probAdvance: 'Menang (termasuk perpanjangan waktu dan adu penalti)',
  ...
  exportCalendarHint: 'Unduh file .ics yang dapat Anda impor ke aplikasi kalender mana pun.',
  exportScope: 'Pertandingan yang diekspor',
  exportScopeFiltered: 'Sesuai filter di halaman Pertandingan',
  exportScopeFavorites: 'Tim saya',
  exportScopeFavoritesEmpty: 'Pilih tim Anda di atas terlebih dahulu.',
  exportScopeAll: 'Semua pertandingan',
  exportUpcomingOnly: 'Hanya pertandingan yang belum dimulai',
  ...
  aimsRealMatch: 'Pertandingan nyata',
